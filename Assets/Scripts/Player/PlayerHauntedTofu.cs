...
namespace Player
{
    public class PlayerHauntedTofu : PlayerCharacter
    {
        ...
        {
            var damageOut = currentHealth * (100 - EnemyManager.instance.targetEnemy.enduranceStat) / 100 * 0.2f;
        ...
        public virtual void UtilitySkill_01()
        {
            ...
            var damageOut = missingHealth * (100 - EnemyManager.instance.targetEnemy.enduranceStat) / 100 * 0.1f;
            LogManager.instance.InstantiateDamageLog(characterName, EnemyManager.instance.targetEnemy.characterName, damageOut);
